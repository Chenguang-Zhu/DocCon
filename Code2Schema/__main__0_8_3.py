...
from code2schema import code2Schema
...
def parse_args(detector_classes, printer_classes):  # pylint: disable=too-many-statements
    ...
    parser.add_argument(
        ...
        help=argparse.SUPPRESS,
        type=str,
        default=os.path.abspath("./library-facts/openzeppelin-tmp/openzeppelin")
    )
